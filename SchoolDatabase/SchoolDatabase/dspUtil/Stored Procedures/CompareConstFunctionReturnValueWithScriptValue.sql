CREATE PROC [dspUtil].[CompareConstFunctionReturnValueWithScriptValue]
...
BEGIN
	...
	EXEC dspUtil.LogTrace @ProcId = @@PROCID, @Message = N'Getting Function Name';
	...
	BEGIN TRY
		EXEC dspUtil.LogTrace @ProcId = @@PROCID, @Message = N'Getting Function Value';
	...
	END TRY
	BEGIN CATCH
		EXEC dspUtil.LogTrace @ProcId = @@PROCID, @Message = 'ConstFunctionValue has written before ConstFunctionName!';
	END CATCH;

	-- Getting Function Id
	EXEC dspUtil.LogTrace @ProcId = @@PROCID, @Message = N'Getting Function Id';
	BEGIN TRY
